...
export function CodePreview({
  ...
  const areaStyle =
    "border border-border rounded-lg min-h-[350px] flex items-center justify-center p-2 relative overflow-hidden";
  const codeAreaStyle =
    "p-4 min-h-auto border border-border rounded-lg bg-black overflow-x-auto";
