...
export function CodePreview({
  ...
  const areaStyle =
    "border border-border rounded-lg min-h-[350px] flex items-center justify-center p-2 relative overflow-hidden max-w-sm max-w-3xl w-[92vw] md:w-screen";
  const codeAreaStyle =
    "p-4 min-h-auto border border-border rounded-lg bg-black overflow-x-auto max-w-3xl w-[92vw] md:w-screen";
